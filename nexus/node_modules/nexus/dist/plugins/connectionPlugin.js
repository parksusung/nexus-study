...
exports.ForwardPaginateArgs = {
    first: nullable_1.nullable(args_1.intArg({ description: 'Returns the first n elements from the list.' })),
    after: nullable_1.nullable(args_1.stringArg({ description: 'Returns the elements in the list that come after the specified cursor' })),
};
exports.ForwardOnlyStrictArgs = Object.assign(Object.assign({}, exports.ForwardPaginateArgs), { first: nonNull_1.nonNull(args_1.intArg({ description: 'Returns the first n elements from the list.' })) });
exports.BackwardPaginateArgs = {
    last: nullable_1.nullable(args_1.intArg({ description: 'Returns the last n elements from the list.' })),
    before: nullable_1.nullable(args_1.stringArg({ description: 'Returns the elements in the list that come before the specified cursor' })),
};
exports.BackwardOnlyStrictArgs = Object.assign(Object.assign({}, exports.BackwardPaginateArgs), { last: nonNull_1.nonNull(args_1.intArg({ description: 'Returns the last n elements from the list.' })) });
    ...
    return plugin_1.plugin({
        ...
        fieldDefTypes: [
            utils_1.printedGenTypingImport({
                module: (_a = connectionPluginConfig === null || connectionPluginConfig === void 0 ? void 0 : connectionPluginConfig.nexusSchemaImportId) !== null && _a !== void 0 ? _a : utils_1.getOwnPackage().name,
        ...
        onInstall(b) {
            ...
            if (pluginExtendConnection) {
                utils_1.eachObj(pluginExtendConnection, (val, key) => {
                    dynamicConfig.push(`${key}${val.requireResolver === false ? '?:' : ':'} core.FieldResolver<core.FieldTypeName<TypeName, FieldName>, "${key}">`);
                });
            }
            if (pluginExtendEdge) {
                const edgeFields = utils_1.mapObj(pluginExtendEdge, (val, key) => `${key}${val.requireResolver === false ? '?:' : ':'} connectionPluginCore.EdgeFieldResolver<TypeName, FieldName, "${key}">`);
                ...
                factory({ typeName: parentTypeName, typeDef: t, args: factoryArgs, stage, builder, wrapping }) {
                    ...
                    if (!b.hasType(connectionName)) {
                        b.addType(objectType_1.objectType({
                            ...
                            definition(t2) {
                                ...
                                provideArgs(t2, () => {
                                    if (pluginExtendConnection) {
                                        utils_1.eachObj(pluginExtendConnection, (extensionFieldConfig, extensionFieldName) => {
                                            var _a;
                                            t2.field(extensionFieldName, Object.assign(Object.assign({}, extensionFieldConfig), { resolve: (_a = fieldConfig[extensionFieldName]) !== null && _a !== void 0 ? _a : graphql_1.defaultFieldResolver }));
                                        });
                                    }
                    ...
                    if (!b.hasType(edgeName)) {
                        b.addType(objectType_1.objectType({
                            ...
                            definition(t2) {
                                t2.field('cursor', {
                                    type: cursorType !== null && cursorType !== void 0 ? cursorType : nonNull_1.nonNull('String'),
                                ...
                                provideArgs(t2, () => {
                                    if (pluginExtendEdge) {
                                        utils_1.eachObj(pluginExtendEdge, (val, key) => {
                                            var _a, _b;
                                            t2.field(key, Object.assign(Object.assign({}, val), { resolve: (_b = (_a = fieldConfig.edgeFields) === null || _a === void 0 ? void 0 : _a[key]) !== null && _b !== void 0 ? _b : graphql_1.defaultFieldResolver }));
                                        });
                                    }
                                ...
                                return plugin_1.completeValue(fieldConfig.resolve(root, args, ctx, info), (val) => {
                                    if (val && val.nodes === undefined) {
                                        return withArgs(args, Object.assign({ get nodes() {
                                                return plugin_1.completeValue(val.edges, (edges) => edges.map((edge) => edge.node));
                                            } }, val));
                                    }
                    ...
                    if (wrapping) {
                        ...
                        wrappedConnectionName = wrapping_1.applyNexusWrapping(connectionName, wrapping);
                    }
                    else {
                        if (fieldConfig.nullable === true) {
                            wrappedConnectionName = nullable_1.nullable(wrappedConnectionName);
                        }
                        else if (fieldConfig.nullable === false) {
                            wrappedConnectionName = nonNull_1.nonNull(wrappedConnectionName);
                        }
                    }
...
function nonConnectionFieldProps(fieldConfig) {
    const { additionalArgs, cursorFromNode, disableBackwardPagination, disableForwardPagination, extendConnection, extendEdge, inheritAdditionalArgs, nodes, pageInfoFromNodes, resolve, type, validateArgs, strictArgs, nullable } = fieldConfig, rest = tslib_1.__rest(fieldConfig, ["additionalArgs", "cursorFromNode", "disableBackwardPagination", "disableForwardPagination", "extendConnection", "extendEdge", "inheritAdditionalArgs", "nodes", "pageInfoFromNodes", "resolve", "type", "validateArgs", "strictArgs", "nullable"]);
    return rest;
}
function makeResolveFn(pluginConfig, fieldConfig) {
    ...
    return (root, args, ctx, info) => {
        ...
        const resolveAllNodes = () => {
            ...
            cachedNodes = plugin_1.completeValue((_a = nodesResolve(root, formattedArgs, ctx, info)) !== null && _a !== void 0 ? _a : null, (allNodes) => {
        ...
        const resolveEdgesAndNodes = () => {
            ...
            cachedEdges = plugin_1.completeValue(resolveAllNodes(), (allNodes) => {
                if (!allNodes) {
                ...
                iterateNodes(allNodes, args, (maybeNode, i) => {
                    if (utils_1.isPromiseLike(maybeNode)) {
                        ...
                        resolvedNodeList.push(maybeNode);
                        resolvedEdgeList.push(withArgs(args, {
                            node: maybeNode,
        ...
        const resolvePageInfo = () => {
            return plugin_1.completeValue(resolveAllNodes(), (allNodes) => plugin_1.completeValue(resolveEdgesAndNodes(), ({ edges }) => plugin_1.completeValue(allNodes
        ...
        return withArgs(args, {
            get nodes() {
                return plugin_1.completeValue(resolveEdgesAndNodes(), (o) => o.nodes);
            },
            get edges() {
                return plugin_1.completeValue(resolveEdgesAndNodes(), (o) => o.edges);
            },
            get pageInfo() {
...
function provideArgs(block, fn) {
    ...
    block.field = function (fieldName, config) {
        ...
        fieldDef.call(this, fieldName, Object.assign(Object.assign({}, config), { resolve(root, args, ctx, info) {
