...
export interface AbstractTypeResolver<TypeName extends string> {
    (source: SourceValue<TypeName>, context: GetGen<'context'>, info: GraphQLResolveInfo, abstractType: GraphQLAbstractType): MaybePromise<AbstractResolveReturn<TypeName> | null>;
}
/**
 ...
 */
info: GraphQLResolveInfo) => MaybePromise<ResultValue<TypeName, FieldName>> | MaybePromiseDeep<ResultValue<TypeName, FieldName>>;
...
export declare type Discriminate<TypeName extends string, Required extends 'required' | 'optional', Type = SourceValue<TypeName>> = Type extends {
    __typename: TypeName;
} ? Type : Type extends {
    __typename?: TypeName;
