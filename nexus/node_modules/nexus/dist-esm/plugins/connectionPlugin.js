                                ...
                                provideArgs(t2, () => {
                                    if (pluginExtendConnection) {
                                        eachObj(pluginExtendConnection, (extensionFieldConfig, extensionFieldName) => {
                                            var _a;
                                            t2.field(extensionFieldName, Object.assign(Object.assign({}, extensionFieldConfig), { resolve: (_a = fieldConfig[extensionFieldName]) !== null && _a !== void 0 ? _a : defaultFieldResolver }));
                                        });
                                    }
                                ...
                                provideArgs(t2, () => {
                                    if (pluginExtendEdge) {
                                        eachObj(pluginExtendEdge, (val, key) => {
                                            var _a, _b;
                                            t2.field(key, Object.assign(Object.assign({}, val), { resolve: (_b = (_a = fieldConfig.edgeFields) === null || _a === void 0 ? void 0 : _a[key]) !== null && _b !== void 0 ? _b : defaultFieldResolver }));
                                        });
                                    }
