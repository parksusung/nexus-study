import { NexusObjectTypeConfig } from './objectType';
/**
 ...
 *     for more detail.
 */
export declare function mutationType(config: Omit<NexusObjectTypeConfig<'Mutation'>, 'name'>): import("./objectType").NexusObjectTypeDef<"Mutation">;
